    ...
    <form class="form form-horizontal" id="form-article-add">
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="" placeholder="" id="articletitle" name="articletitle" style="width:95%;">
            </div>
        </div>
        {{--<div class="row cl">--}}
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                ...
                <div id="test-editormd" style="width: 100% ! important;">
                    <textarea name="test-editormd" style="display:none;" id="editormd"></textarea>
                </div>
